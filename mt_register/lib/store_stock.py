...
def store(browser: selenium.webdriver.chrome.webdriver.WebDriver):  # type: ignore # noqa
    ...
    try:
        mail_element = browser.find_element(
            by=By.NAME, value="m_login_mail_address"
        )  # noqa
    ...
    try:
        browser.find_element(
            by=By.CSS_SELECTOR, value=".e_btn_active.e_btn_large"
        ).click()
    except Exception:
        pass
    ...
    try:
        # Get stock value
        now_stock_element = browser.find_element(
            by=By.XPATH, value='//*[@id="container"]/div[2]/div[2]/dl/dd/span[2]'
        )
        ...
        logout_element = browser.find_element(
            by=By.XPATH, value='//*[@id="m_self_reissue"]/ul/li[3]/a/span[2]'
        )
        ...
        # click "Kouza zandaka"
        zandaka_button_element = browser.find_element(
        ...
        exp_inc_switch_element = browser.find_element(
        ...
        banck_amount_element = browser.find_element(
            by=By.CLASS_NAME, value="input-amount"
        )
        banck_amount_element.clear()
        banck_amount_element.send_keys(stock_value)

        update_element = browser.find_element(
            by=By.CSS_SELECTOR, value=".update.ng-scope"
        )
